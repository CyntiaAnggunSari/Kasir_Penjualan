...
<html>
    <head>
        ...
        <title>Tokoh Oleh Oleh Cyntia - Sistem Informasi Kasir Penjualan </title>
        <meta content="Admin Dashboard" name="description" />
        <meta content="Mannatthemes" name="author" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />

        <link rel="shortcut icon" href="<?= base_url() ?>/assets/images/gambar.png">
            ...
            <div class="left side-menu">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><i class="mdi mdi-assistant"></i> Tokoh Cyntia</a>
                        <!-- <a href="index.html" class="logo"><img src="<?= base_url() ?>/assets/images/logo.png" height="34" alt="logo"></a> -->
                    </div>
                </div>
                            ...
                            <ul class="list-inline float-right mb-0">
                                ...
                                <li class="list-inline-item dropdown notification-list hide-phone">
                                    <a class="nav-link dropdown-toggle arrow-none waves-effect text-white" data-toggle="dropdown" href="#" role="button"
                                        ...
                                        Indonesia <img src="<?= base_url() ?>/assets/images/flags/bendera.PNG" class="ml-2" height="16" alt=""/>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right language-switch">
                                        ...
                                        <a class="dropdown-item" href="#"><img src="<?= base_url() ?>/assets/images/flags/bendera.PNG" alt="" height="16"/><span> Indonesia </span></a>
                                    </div>
                                </li>
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    ...
                                    ?>
                                        <img src="<?php echo base_url().'/assets/images/users/'.$u.'.jpeg'?>" alt='username' class="rounded-circle">
                                    </a>
